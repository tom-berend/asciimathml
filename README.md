...
<math title="norm(vec x)"><mstyle mathcolor="white" fontsize="1em" mathsize="1em" fontfamily="serif" displaystyle="true"><mrow><mrow><mo>∥</mo><mover><mrow><mi>x</mi></mrow><mo>→</mo></mover><mo>∥</mo></mrow></mrow></mstyle></math>
